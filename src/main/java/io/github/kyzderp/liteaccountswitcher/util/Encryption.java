...
{
	public static String currentKey = "Password";
	...
	public static String decrypt(String strToDecrypt) throws FailedDecryptionException 
	{
		try
		{
			Cipher cipher = Cipher.getInstance("AES/ECB/PKCS5PADDING");
		...
		{
			throw new FailedDecryptionException();
		}
	}
}